...
func getCookieClubMessage() string {
	...
	message +=
		"\n **Welcome to Cookie Consumption Club!**" +
			...
			"\n :cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie::cookie:" +
